...
public class EventoServiceTest
{
    ...
    private readonly Mock<IResponsavelEventoRepository> _repositoryResponsavelEvento;
    ...
    public EventoServiceTest()
    {
        ...
        _repositoryResponsavelEvento = new Mock<IResponsavelEventoRepository>();
        _service = new EventoService(_repository.Object, _logger.Object, _validatorRequest.Object, _validatorUpdate.Object, _repositoryResponsavelEvento.Object);
    }
    ...
    public class CriarEvento : EventoServiceTest
    {
        ...
        [Fact]
        public async Task Deve_Falhar_Criar_Evento_Quando_Responsavel_Ja_Tem_Evento_Marcado_No_Mesmo_Dia()
        {
            //Arrange
            var request = new EventoRequest
            {
    ...
    public class AtualizarEvento : EventoServiceTest
    {
        ...
        [Fact]
        public async Task Deve_Falhar_Atualizar_Evento_Quando_Responsavel_Ja_Tem_Evento_Marcado_No_Mesmo_Dia()
        {
            //Arrange
            var request = new EventoUpdate
            {
